...
\include{2-contexto}
\include{2.1-problema}
\include{2.2-estado_da_arte}
\include{2.3-rollback_netcode}
\include{3-proposta-de-solucao}
\include{3.1-adaptation}
\include{3.2-success-metrics}
\include{3.3-data_gathering}
\include{4-ciclo_1_lstm}
\include{4.1-proposta_de_solucao_lstm}
\include{4.2-avaliacao-lstm}
\include{5-ciclo-2-dtw}
\include{5.1-proposta_de_solucao-dtw}
\include{5.2-avaliacao-dtw}
\include{6-conclusoes}

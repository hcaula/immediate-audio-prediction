...
Neste Capítulo, descreveremos a metodologia utilizada para realizar os experimentos, demonstraremos seus resultados e, a partir dele, tiraremos conclusões, de acordo com as métricas de sucesso descritas na \secref{sec:success_metrics}.

\input{4.1-metodologia}
\input{4.2-avaliacao}